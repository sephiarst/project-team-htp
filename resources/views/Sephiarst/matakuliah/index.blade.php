                ...
                <table class="border-collapse border border-slate-500">
                    <thead class="bg-slate-700 text-white">
                        <tr>
                            ...
                            <th class="border border-slate-600 px-2 py-1">mk id</th>
                            <th class="border border-slate-600 px-2 py-1">nama mk</th>
                            <th class="border border-slate-600 px-2 py-1">sks</th>
                            <th class="border border-slate-600 px-2 py-1">semester</th>
                            <th class="border border-slate-600 px-2 py-1">kurikulum id</th>
                        </tr>
                    </thead>
                    <tbody>
                        @php($no = 1)
                        @foreach ($matakuliah as $row)
                            ...
                            <tr class="hover:bg-slate-800 hover:text-white">
                            <th class="border border-slate-600 px-2 py-1">{{ $no++ }}</th>
                                <td class="border border-slate-600 px-2 py-1">{{ $row->mk_id }}</td>
                                ...
                                <td class="border border-slate-600 px-2 py-1">{{ $row->kurikulum }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
